...
declare class CombatModifiers implements CombatModifierObject<number> {
    increasedFlatMeleeDefenceBonusPerDefence: number;
    increasedFlatRangedDefenceBonusPerDefence: number;
...
interface StandardModifierObject<Standard> extends CombatModifierObject<Standard> {
    increasedFlatMeleeDefenceBonusPerDefence: Standard;
    increasedFlatRangedDefenceBonusPerDefence: Standard;

...
declare class CombatModifiers implements CombatModifierObject<number> {
    increasedFlatMeleeDefenceBonusPer30Defence: number;
    increasedFlatRangedDefenceBonusPer30Defence: number;
...
interface StandardModifierObject<Standard> extends CombatModifierObject<Standard> {
    increasedFlatMeleeDefenceBonusPer30Defence: Standard;
    increasedFlatRangedDefenceBonusPer30Defence: Standard;

export const ja = {
    ...
    You_Do_Not_Have_Enough_Materials_Single_Species: 'この楽器をアップグレードするための材料が不足しています。',
    ...
    Chance_To_Obtain_Shrimp_While_Training_Profile_Positive: '音楽のトレーニング中にエビを入手する確率 +${value}%',
    Chance_To_Obtain_Shrimp_While_Training_Profile_Negative: '音楽のトレーニング中にエビを入手する確率 -${value}%',
    Increased_Mastery_XP_Per_Variel: '占星術のVariel星座の満点スターごとに+${value}% ${skillName}マスタリーXP',
    Single_Species_Human: 'ギター',
    Single_Species_Cyclone: 'バンジョー',
    Single_Species_Animal_Allegiance: 'スネアドラム',
    Single_Species_Become_Ethereal: 'アコーディオン',
    Single_Species_Kynes_Peace: 'ブズーキ',
    Single_Species_Flute: 'フルート',
    Single_Species_Slow_Time: 'マラカス',
    Single_Species_Whirlwind_Sprint: '木琴',
    Single_Species_Throw_Voice: 'サックス',
    Single_Species_Dismay: 'バイオリン',
    Single_Species_Battle_Fury: 'ボンゴ',
    Single_Species_French_Horn: 'フレンチホルン',
    ...
    ITEM_NAME_Mastery_Token_Profile: 'マスタリートークン（音楽）',
    MASTERY_BONUS_Profile_0: '各レベルでこの楽器で獲得するGPが+10増加します。',
    MASTERY_BONUS_Profile_1: '最初の雇用修飾子。',
    MASTERY_BONUS_Profile_2: '2つ目の雇用修飾子の解除が可能になります。',
    MASTERY_BONUS_Profile_3: '3つ目の雇用修飾子の解除が可能になります。',
    MASTERY_BONUS_Profile_4: 'この楽器のバード雇用コストが-5%されます。',
    MASTERY_BONUS_Profile_5: '4つ目の雇用修飾子の解除が可能になります。',
    MASTERY_CHECKPOINT_Profile_0: '+3% 音楽スキルXP増加',
    MASTERY_CHECKPOINT_Profile_1: '+5% 音楽マスタリーXP増加',
    MASTERY_CHECKPOINT_Profile_2: '音楽のインターバルが0.25秒減少します。',
    MASTERY_CHECKPOINT_Profile_3: 'バードの雇用コストが-5%されます。',

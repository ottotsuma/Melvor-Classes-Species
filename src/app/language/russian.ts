export const ru = {
    ...
    Thuum_GP_Positive: '+${value}% GP музыки',
    Thuum_GP_Negative: '-${value}% GP музыки',
    Shout_Equip_Limit_Positive: '+${value} Лимит найма барда',
    Shout_Equip_Limit_Negative: '-${value} Лимит найма барда',
    Sheet_Thuum_Drop_Chance_Positive: '+${value}% шанс выпадения нотного листа',
    Sheet_Thuum_Drop_Chance_Negative: '-${value}% шанс выпадения нотного листа',
    ...
    ITEM_NAME_Thuum_Skillcape: 'Мантия музыкального мастерства',
    ITEM_NAME_Superior_Thuum_Skillcape: 'Превосходная мантия музыкального мастерства',
    ...
    ITEM_DESCRIPTION_Shouts_Boots:
        "+2% XP музыки<br><span class='text-warning'>Если надет весь комплект Барда: +8% XP мастерства музыки</span>",
    ITEM_NAME_Thuum_Scroll_Of_XP: 'Свиток музыкального опыта',
    ...
    ITEM_NAME_Mastery_Token_Thuum: 'Жетон мастерства (музыка)',
    MASTERY_BONUS_Thuum_0: 'Каждый уровень дает +10 GP только для этого инструмента.',
    MASTERY_BONUS_Thuum_1: 'Первый модификатор при найме.',
    MASTERY_BONUS_Thuum_2: 'Возможность разблокировать второй модификатор при найме.',
    MASTERY_BONUS_Thuum_3: 'Возможность разблокировать третий модификатор при найме.',
    MASTERY_BONUS_Thuum_4: '-5% стоимость найма барда только для этого инструмента.',
    MASTERY_BONUS_Thuum_5: 'Возможность разблокировать четвертый модификатор при найме.',
    MASTERY_CHECKPOINT_Thuum_0: '+3% увеличенный XP музыки',
    MASTERY_CHECKPOINT_Thuum_1: '+5% увеличенный XP мастерства музыки',
    MASTERY_CHECKPOINT_Thuum_2: 'Сокращен интервал музыки на 0,25 секунды.',
    MASTERY_CHECKPOINT_Thuum_3: '-5% стоимость найма барда',

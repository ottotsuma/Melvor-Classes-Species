export class ClassesTranslation {
    constructor(private readonly context: Modding.ModContext) {}

    public init() {
        this.context.patch(Item, 'name').get(function (patch) {
            if (this.namespace === 'namespace_classes') {
        ...
        this.context.patch(Item, 'description').get(function (patch) {
            if (this.namespace === 'namespace_classes' && this._customDescription !== undefined) {
        ...
        this.context.patch(ShopPurchase, 'name').get(function (patch) {
            if (this.namespace === 'namespace_classes' && this._customName !== undefined) {
